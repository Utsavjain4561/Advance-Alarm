...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,TurnOff.Selection,Counter {
    ...
    public boolean REP_CLICKED=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                returnIntent.putExtra(BaseActivity.ALARM_HOUR,mHour);
                returnIntent.putExtra(BaseActivity.ALARM_MIN,mMinutes);
                if(exists==false) {
                    returnIntent.putExtra(BaseActivity.ALARM_ID, alarm_id);
                    returnIntent.putExtra(EXISTING_CALL,false);
                }else {
                    returnIntent.putExtra(BaseActivity.ALARM_ID, a.alarm_id);
                    returnIntent.putExtra(EXISTING_CALL,true);
                }
                returnIntent.putExtra(BaseActivity.RINGTONE,alarm_ring);
                ...
                returnIntent.putExtra(BaseActivity.OFF_METHOD,method);
                returnIntent.putExtra(BaseActivity.SHAKE_COUNT,shake_cnt);
                returnIntent.putExtra(BaseActivity.TAP_COUNT,tap_cnt);
                returnIntent.putExtra(BaseActivity.WEEKDAYS,weeks);
